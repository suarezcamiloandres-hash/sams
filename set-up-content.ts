...
async function main() {
  ...
  // Source scaffold content comes from Prismic's public "fizzi" course repo.
  // After migrating, edit the texts/flavors in your own Prismic repo to the
  // Sam's Coffee copy (see README).
  const sourceClient = createClient("fizzi");
  console.log(
